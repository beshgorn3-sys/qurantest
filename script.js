document.addEventListener('DOMContentLoaded', () => {
    ...
    function nextQuestion() {
        ...
        const questionTypes = Object.keys(allQuestionGenerators).filter(type => type.includes('audio'));
        ...
        // *** تعديل هنا: التقاط قائمة الانتظار إذا وجدت ***
        if (questionData.audioQueue && questionData.audioQueue.length > 0) {
            audioQueue = questionData.audioQueue;
            currentAudioIndex = 0;
        } else {
            audioQueue = [];
            currentAudioIndex = 0;
        ...
        // *** تعديل هنا: بدء تشغيل الصوت الأول في القائمة إذا وجدت ***
